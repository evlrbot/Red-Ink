<?php
$xml= "<chart caption='Financial Chart' xAxisName='Month' yAxisName='$' showValues='0' numberPrefix='' paletteColors='FF0000,0000FF' canvasbgColor='FFFFFF' canvasBorderColor='000000' canvasBorderThickness='2'>";
